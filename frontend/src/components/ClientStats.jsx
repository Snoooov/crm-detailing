...
const ClientStats = ({ clientId }) => {
  ...
  return (
    <div className="card" style={{ marginTop: 24 }}>
      <h2 style={{ fontSize: 16, fontWeight: 600, marginBottom: 16 }}>Statystyki klienta</h2>
      ...
      {stats.topService && (
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 11, color: '#0369a1', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Najczęstsza usługa
            </div>
            <div style={{ fontWeight: 600, color: '#0c4a6e' }}>
              {stats.topService.service_name}
              <span style={{ color: '#0369a1', fontWeight: 400, marginLeft: 8, fontSize: 13 }}>
      ...
      {stats.statusBreakdown.length > 0 && (
        <div>
          <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 600, marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
